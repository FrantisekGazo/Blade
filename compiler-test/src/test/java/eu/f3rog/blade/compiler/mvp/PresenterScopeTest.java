    ...
    public void onePresenter() {
        ...
        JavaFileObject expected = generatedFile("com.example", "MyActivity_Helper")
                ...
                .body(
                        ...
                        "       @Weave(into = \"getSystemService\", args = {\"java.lang.String\"}, statement = \"if (blade.mvp.PresenterManager.ACTIVITY_ID.equals($1)) { return this.mActivityId; }\"),",
                        "       @Weave(into = \"onDestroy\", statement = \"if (this.isFinishing()) { blade.mvp.PresenterManager.removePresentersFor(this); }\"),",
                        "       @Weave(into = \"onCreate\", args = {\"android.os.Bundle\"}, statement = \"if ($1 != null) { this.mActivityId = $1.getString('blade:activity_id'); } else { this.mActivityId = java.util.UUID.randomUUID().toString(); }\"),",
                        "       @Weave(into = \"onSaveInstanceState\", args = {\"android.os.Bundle\"}, statement = \"$1.putString('blade:activity_id', this.mActivityId);\")",
                        "   })",
