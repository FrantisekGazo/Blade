...
import eu.f3rog.blade.compiler.new_approach.module.arg.ArgProcessorModule;
import eu.f3rog.blade.compiler.new_approach.module.extra.ExtraProcessorModule;
import eu.f3rog.blade.compiler.util.BaseProcessor;
import eu.f3rog.blade.compiler.util.ProcessorError;

@AutoService(Processor.class)
public class BladeProcessor2 extends BaseProcessor {
